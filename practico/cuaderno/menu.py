...
class Menu:
    ...
    def run(self):
        ...
        while True:
            ...
            #Obtiene la elección del diccionario y ejecuta la elección
    ...
    def mostrar_notas(self, notas=None):
        '''Si se le pasan notas, muestra las notas ingresadas con un formato,
        si no se el pasan notas muestra todas las notas del cuaderno'''
        if not notas:
